...
def generate_launch_description():
    ...
    # RViz
    rviz_config_file = (
        get_package_share_directory("motoman_robotcrtl")
        + "/rviz/moveit_servo.rviz"
    )
    ...
    motoman_controller_spawner = launch_ros.actions.Node(
        package="controller_manager",
        executable="spawner",
        arguments=["motoman_controller", "-c", "/controller_manager"],
    )
